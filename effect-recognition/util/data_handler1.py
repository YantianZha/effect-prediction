...
class DataHandler(object):
  ...
  def GetLabels(self, filename):
	...
	print "int(line.strip())", int(line.strip())
...
class TrainProto(object):
  def __init__(self, bs, maxlen, stride, dataset, fps=30):
    ...
    self.fps = fps
    if dataset=='ucf11':
      self.data_file       = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/train_features.h5'
      self.num_frames_file = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/train_framenum_s.txt'
      self.labels_file     = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/train_labels_s.txt'
      self.vid_name_file   = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/train_filename_s.txt'
...
class TestValidProto(object):
  def __init__(self, bs, maxlen, stride, dataset, fps=30):
    ...
    self.fps = fps
    if dataset=='ucf11':
      self.data_file       = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/valid_features.h5'
      self.num_frames_file = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/valid_framenum.txt'
      self.labels_file     = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/valid_labels.txt'
      self.vid_name_file   = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/valid_filename.txt'
      self.dataset_name    = 'features'
    elif dataset=='h2mAP':
...
class TestTestProto(object):
  def __init__(self, bs, maxlen, stride, dataset, fps=30):
    ...
    self.fps = fps
    if dataset=='ucf11':
      self.data_file       = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/test_features.h5'
      self.num_frames_file = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/test_framenum.txt'
      self.labels_file     = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/test_labels.txt'
      self.vid_name_file   = '/home/yochan/DL/action-recognition-visual-attention-master/dataset/test_filename.txt'
      self.dataset_name    = 'features'
    elif dataset=='h2mAP':
