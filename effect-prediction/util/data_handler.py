...
class DataHandler(object):
  ...
  def GetBatchAcEf(self, data_pb, verbose=False):
    ...
    EffLabel = self.GetLabels('/home/yochan/DL/effect-recognition/dataset/test_labels.txt')
    num_f = []						# number of frames in each example
    init_labels_ = []
    labels_ = []
    lengths_ = []
...
#	  print "Yantian, self.batch_data_[:,j, :].shape", self.batch_data_[:,j, :].shape	# (30, 49, 1024)
	  ...
	  new_handler = tmp_handler.reshape([self.handler.shape[0], 49, 1024]).astype('float32')  # Yantian
          #print "##################"
          self.batch_data_[:,j, :] = new_handler[start:end:skip, :]  # Yantian
          #print "self.batch_data_.shape", self.batch_data_.shape
         #self.batch_data_[n:,j, :] = np.tile(self.batch_data_[n-1,j, :],(self.seq_length_-n,1))
          #print "self.seq_length_-n", self.seq_length_-n
          #print "self.batch_data_[n-1,j, :]", self.batch_data_[n-1,j, :].shape
...
#      self.labels_file     = '/home/yochan/DL/effect-recognition/dataset/train_AC_labels.txt'
...
#      self.labels_file     = '/home/yochan/DL/effect-recognition/dataset/train_AC_labels.txt'
#      self.vid_name_file   = '/home/yochan/DL/effect-recognition/dataset/train_filename.txt'
      self.data_file       = '/home/yochan/DL/effect-recognition/dataset/EP2/test_ef_throw.h5'
      self.num_frames_file = '/home/yochan/DL/effect-recognition/dataset/EP2/test_effect/test_ef_throw_framenum.txt'
      self.labels_file     = '/home/yochan/DL/effect-recognition/dataset/EP2/test_effect/test_ef_throw_labels.txt'
      self.vid_name_file   = '/home/yochan/DL/effect-recognition/dataset/EP2/test_effect/test_ef_throw_filename.txt'
      self.dataset_name    = 'features'
    elif dataset=='h2mAP':
...
class TestTestProto(object):
  def __init__(self, bs, maxlen, stride, dataset, fps=30):
    ...
    self.fps = fps
    if dataset=='ucf11':
#      self.data_file       = '/home/yochan/DL/effect-recognition/dataset/effect_test.h5'
#      self.num_frames_file = '/home/yochan/DL/effect-recognition/dataset/test_framenum.txt'
#      self.labels_file     = '/home/yochan/DL/effect-recognition/dataset/test_AC_labels.txt'
#      self.vid_name_file   = '/home/yochan/DL/effect-recognition/dataset/test_filename.txt'
