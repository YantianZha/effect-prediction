...
videoDir = '/Volumes/win8_1/EP2/train/put_down';
%videoDir = '/Users/yantian/Documents/DL_data/action-recognition-visual-attention/UCF11_updated_mpg_small';
[labels, videoPath, rl_videoPath, framenum] = get_im_info_EF(videoDir);

t = rl_videoPath(1,:);
v = framenum(1,:);

fid = fopen('/Volumes/win8_1/EP2/test_effect/train_ef_put_down_filename.txt','w');
%fid1 = fopen('/Volumes/win8_1/EP2/test_effect/train_ef_put_down_labels.txt','w');
fid2 = fopen('/Volumes/win8_1/EP2/test_effect/train_ef_put_down_framenum.txt','w');
formatSpec = '%s\n';
formatSpec1 = '%d\n';
n = size(t);
for i=1:n(2)
